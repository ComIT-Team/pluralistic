        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-[30px] max-w-sm mx-auto md:max-w-none md:mx-0'>
          {data.map((item) => (
            <div key={item.id} className='m-6'>
              <div className='border border-gray-400 h-[300px] mb-4 relative overflow-hidden group transition'>
              ...
              <div>
                ...
                <Link to={`/product/${id}`}>
                  <h2 className='no-underline text-base font-semibold mb-1 '>{item.title}</h2>
                </Link>
                <Link>
